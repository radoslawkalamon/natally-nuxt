...
describe('Utils / Factory / Head / Post / Story', () => {
  test('shall match snapshot', () => {
    const dto = {
      ...
      imageCover: '/images/opowiadania.proste-rzeczy.1x.webp',
      imageCover2x: '/images/opowiadania.proste-rzeczy.2x.webp',
      imagePath: '/images/',
      imageOpenGraph: '/images/opowiadania.proste-rzeczy.opengraph.jpg',
      timeReading: 31,

...
import { DTOMetaPostPoem } from './dto.meta.post.poem'
...
const category = 'Poezja 3.14'
const categoryPath = '/poezja-314/'

export const factoryHeadPostPoem = ({ createdAt, description, imageOpenGraph, title, path, updatedAt }: DTOMetaPostPoem): MetaInfo => ({
  ...
  meta: [
    ...
    { name: 'twitter:label1', content: 'Napisane przez' },
    { name: 'twitter:data1', content: 'Radosław Kalamon' }
  ],
  script: [{
